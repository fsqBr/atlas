...
| `Atlas:Vulnerabilities` | `SyncEnabled`, `SyncUrls`, `OsvBundlePath` — add `https://osv-vulnerabilities.storage.googleapis.com/Maven/all.zip` to `SyncUrls` to enable Java CVE matching |
...
**Which languages?** C# (semantic where symbols resolve) and VB.NET through Roslyn; Java (syntactic: metrics,
complexity, security patterns, plus Maven/Gradle manifests, JDK/framework end-of-life and OSV CVEs), SQL scripts and
