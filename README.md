...
<table>
  <tr>
    <td align="center"><a href="docs/images/dashboard.png"><img src="docs/images/dashboard.png" width="280" alt="Portfolio dashboard"></a><br><sub>Portfolio dashboard</sub></td>
    <td align="center"><a href="docs/images/overview.png"><img src="docs/images/overview.png" width="280" alt="Assessment overview"></a><br><sub>Assessment overview</sub></td>
    <td align="center"><a href="docs/images/findings.png"><img src="docs/images/findings.png" width="280" alt="Findings"></a><br><sub>Findings</sub></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/modernization.png"><img src="docs/images/modernization.png" width="280" alt="Modernization"></a><br><sub>Modernization strategies, effort, roadmap</sub></td>
    <td align="center"><a href="docs/images/savings.png"><img src="docs/images/savings.png" width="280" alt="Business case"></a><br><sub>Business case: cost, legacy cost, payback</sub></td>
    <td align="center"><a href="docs/images/portfolio.png"><img src="docs/images/portfolio.png" width="280" alt="Portfolio benchmark"></a><br><sub>Portfolio benchmark</sub></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/ai-estate.png"><img src="docs/images/ai-estate.png" width="280" alt="AI estate inventory"></a><br><sub>AI estate: providers, approval status, composition</sub></td>
    <td align="center"><a href="docs/images/ai-usage-live.png"><img src="docs/images/ai-usage-live.png" width="280" alt="Developer usage, live and forecast"></a><br><sub>Developer usage: live panel, forecast, per developer</sub></td>
    <td align="center"><a href="docs/images/ai-model-prices.png"><img src="docs/images/ai-model-prices.png" width="280" alt="Model prices"></a><br><sub>Model prices: yours first, builtin catalog, unpriced suggestions</sub></td>
  </tr>
</table>

<details>
<summary><b>More screens</b> — cost sources and provider guides, approved providers, assessment AI tab, waivers, rule catalog, trend, cost model, compare, Java and Python, dark theme, AI features</summary>
<br>
<table>
  <tr>
    <td align="center"><a href="docs/images/ai-cost-sources.png"><img src="docs/images/ai-cost-sources.png" width="280" alt="Cost sources"></a><br><sub>Cost sources with the per-provider "How to connect" guide</sub></td>
    <td align="center"><a href="docs/images/ai-allowlist.png"><img src="docs/images/ai-allowlist.png" width="280" alt="Approved providers"></a><br><sub>Approved AI providers, edited from the signature catalog</sub></td>
    <td align="center"><a href="docs/images/assessment-ai.png"><img src="docs/images/assessment-ai.png" width="280" alt="Assessment AI tab"></a><br><sub>Assessment AI tab: providers, MCP servers, correlation with PII/secrets</sub></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/waivers.png"><img src="docs/images/waivers.png" width="280" alt="Waivers"></a><br><sub>Waivers: active, history, standing policies, migration</sub></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/rules.png"><img src="docs/images/rules.png" width="280" alt="Rule catalog"></a><br><sub>Rule catalog with live counts and per-tenant severity tuning</sub></td>
    <td align="center"><a href="docs/images/portfolio-trend.png"><img src="docs/images/portfolio-trend.png" width="280" alt="Portfolio trend"></a><br><sub>Portfolio trend, overall and per dimension</sub></td>
    <td align="center"><a href="docs/images/cost.png"><img src="docs/images/cost.png" width="280" alt="Cost model"></a><br><sub>Tenant cost model: your market, your currency</sub></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/compare.png"><img src="docs/images/compare.png" width="280" alt="Compare"></a><br><sub>Compare two assessments</sub></td>
    <td align="center"><a href="docs/images/java.png"><img src="docs/images/java.png" width="280" alt="Java assessment"></a><br><sub>Java: JDK end-of-life, legacy frameworks, javax.* surface</sub></td>
    <td align="center"><a href="docs/images/python.png"><img src="docs/images/python.png" width="280" alt="Python assessment"></a><br><sub>Python: interpreter floors, EOL frameworks, pinned CVEs</sub></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/dashboard-dark.png"><img src="docs/images/dashboard-dark.png" width="280" alt="Dark theme"></a><br><sub>Dark theme, one click away</sub></td>
    <td align="center"><a href="docs/images/ai-rules.png"><img src="docs/images/ai-rules.png" width="280" alt="Business rules"></a><br><sub>AI: business rules recovered from code</sub></td>
    <td align="center"><a href="docs/images/ai-fix.png"><img src="docs/images/ai-fix.png" width="280" alt="AI fix"></a><br><sub>AI: fix as a diff, explanation on the finding</sub></td>
  </tr>
  <tr>
    <td align="center"><a href="docs/images/ai-plan.png"><img src="docs/images/ai-plan.png" width="280" alt="Migration plan"></a><br><sub>AI: migration plan from the deterministic plan</sub></td>
    <td align="center"><a href="docs/images/ai-settings.png"><img src="docs/images/ai-settings.png" width="280" alt="AI settings"></a><br><sub>AI settings: nothing is sent until enabled</sub></td>
    <td></td>
  </tr>
</table>
</details>
...
11. [AI Estate (governance module)](#ai-estate-governance-module)
12. [Web UI](#web-ui)
13. [CI integration and quality gate](#ci-integration-and-quality-gate)
14. [Security and privacy](#security-and-privacy)
15. [Configuration reference](#configuration-reference)
16. [Operations](#operations)
17. [Development](#development)
18. [FAQ](#faq)
19. [Status and limits](#status-and-limits)
20. [Contributing and support](#contributing-and-support)
21. [License](#license)
...
- **The full business case** — modernization cost ranges AND the annual run-rate of staying legacy
  (Windows hosting, extended support exposure, SQL Server consolidation), with a payback per
  strategy — both sides of the decision in the same view and report.
...
- **Portfolio view** — every system side by side: risk distribution, benchmark quartiles, targets, top rules across the
  estate, free-form tags with group roll-ups and filtering, and a two-assessment comparison.
- **Rule catalog in the open** — a Rules page lists every rule Atlas checks (scanner, category, description, how
  much it fires in your estate) with per-tenant severity tuning; finding history survives tuning because
  fingerprints exclude severity.
- **Triage** — suppressions with reason, author and an optional expiry ("accepted for 90 days" — the finding
  reopens by itself), false positives, standing policies per rule/path (expirable too), scope exclusions, full
  audit trail. When a rule's major version is bumped (it changed meaning), waivers are never carried over
  silently: Atlas lists the superseded waivers and migrates only the ones you pick, as new audited decisions.
- **Automation** — scheduled re-runs, signed webhooks, API tokens, a CI quality gate with ready-made GitHub Action,
  Azure DevOps and GitLab CI templates, Slack/Teams notifications for completed runs and an opt-in weekly
  portfolio digest; SARIF import brings other tools' findings (ESLint, Semgrep, Trivy…) in as first-class citizens.
- **AI Estate (governance module)** — what AI each repository actually uses, read from code and manifests against a
  versioned signature catalog: provider SDKs, agent frameworks, direct provider endpoints, retired model references,
  MCP servers your coding assistants are wired to (with read/write/execute class and credentials-in-config checks),
  providers outside your approved list, and the correlation that no traffic-based tool can see: AI calls next to
  personal data or leaked secrets in the same repository. Optional read-only cost connectors (OpenAI, Anthropic incl.
  Claude Code, GitHub Copilot seats) put spend and idle seats in the portfolio report — never per person.
...
| Quality | `quality.*` | Cyclomatic complexity, duplicated blocks, absent tests, coverage from Cobertura/OpenCover reports, APIs gone or discouraged on modern .NET, `[Obsolete]` usage, dead-code candidates (internal types and private members nothing references) |
...
| Java | `java.*` | Maven/Gradle module inventory, JDK targets out of support, end-of-life frameworks (Struts 1, Log4j 1.x, Spring 4, Boot 1.x…), `javax.*`→`jakarta.*` migration surface, vulnerable Maven dependencies (OSV, opt-in bundle); `.java` metrics, complexity and security patterns feed the quality/security rules |
| Python | `python.*` | requirements/pyproject/Pipfile/setup.py package inventory, interpreter floors out of support (Python 2 = High), end-of-life frameworks (Django 1.x/2.x, Flask 1.x, Celery 4, nose, PyCrypto…), vulnerable pinned PyPI dependencies (OSV, opt-in bundle); `.py` metrics, complexity and security patterns feed the quality/security rules |
| AI Estate | `ai.*` | Provider SDKs and agent frameworks in NuGet/npm/PyPI/Maven manifests and in imports, provider API hosts in code and config, model references (retired ones flagged with the replacement), env-var credentials by name, MCP client configs (`.mcp.json`, `.cursor/mcp.json`, `.vscode/mcp.json`, Claude/Gemini/Windsurf/Continue…) with transport, capability class and credential-in-config detection, local runtimes (Ollama, LM Studio, vLLM), and providers outside the approved list — all against the embedded, versioned `ai-signatures.json` catalog |
...
| Portfolio report | `GET /api/portfolio/report` and `/api/portfolio/report.pdf` (`?lang=&tag=&weeks=`) — the whole estate or one product group as a client-ready document: KPIs, risk distribution, weekly health trend, top rules, per-assessment table; same white-label options |
...
| Pull-request comment | `GET /api/assessments/{id}/pr-comment?failOn=&minScore=&failOnNew=&lang=&ai=` — Markdown |
| Portfolio | `GET /api/portfolio`, `GET /api/calibration`, `GET /api/portfolio/trend?weeks=&tag=` (overall, per dimension, per product group) |
| Rules | `GET /api/rules` (catalog + live counts), `PUT /api/rules/{id}/severity` (per-tenant severity tuning) |
| Tags | `PUT /api/assessments/{id}/tags` — free-form labels for portfolio grouping |
| SARIF import | `POST /api/assessments/{id}/sarif` — external tool results as first-class findings |
| Cost model | `GET \| PUT \| DELETE /api/settings/cost` — tenant currency, hourly rate, team size |
| Issues export | `POST /api/assessments/{id}/export/issues` — top findings become GitHub/ADO issues |
| Compliance pack | `GET /api/assessments/{id}/compliance.zip` — privacy + licenses + waivers in one ZIP |
| Demo estate | `POST | DELETE /api/demo` — five fictional assessments to explore the product |
| Notifications | `GET \| PUT /api/settings/notifications` — per-tenant webhook/Slack/Teams/digest |
| Live queue | `GET /api/events/jobs` — server-sent events; the UI falls back to polling |
| Version | `GET /api/version` — the running version, also shown in the UI footer |
...
## AI Estate (governance module)

Atlas reads what AI your repositories actually use — the estate you cannot see from network traffic — and puts it in
every assessment report and in the portfolio report, next to modernization, privacy and secrets.

**What the scanner finds (`ai.*` rules, catalog-driven):**

- Provider SDKs and agent frameworks declared in NuGet, npm, PyPI and Maven/Gradle manifests, or imported in code
  when no manifest declares them (`ai.provider.sdk`, `ai.agent.framework`).
- Provider API hosts written into code or configuration (`ai.provider.direct-endpoint`) and local runtimes such as
  Ollama, LM Studio and vLLM (`ai.local-runtime`).
- Model references, with retired models flagged and the provider's suggested replacement named (`ai.model.retired`).
- MCP servers configured for coding assistants (`.mcp.json`, `.cursor/mcp.json`, `.vscode/mcp.json`, Claude, Gemini,
  Windsurf, Continue…): transport, a read/write/execute capability class, remote hosts (`ai.mcp.remote-server`) and
  credential-looking values committed in the config — fingerprinted, never stored (`ai.mcp.secret-in-config`).
- Providers outside your approved list (`ai.unapproved-provider`, High) — the V0.5 policy is a plain allowlist, edited on the
  *AI estate* page (saved per tenant, applied on the next run) or, as a fallback, in configuration:

```yaml
# docker-compose override — repeat the index for more providers
Atlas__AiEstate__ApprovedProviders__0: azure-openai
Atlas__AiEstate__ApprovedProviders__1: anthropic
```

Without an allowlist the rule stays silent. The signature catalog (`ai-signatures.json`, ~180 signatures with
fixtures) is versioned and embedded; every finding records the catalog hash it was matched against, and
`Atlas:AiEstate:CatalogPath` replaces it wholesale with your own file (same schema, validated on load).

**The report section.** *AI estate* in the executive report shows providers with evidence and approval status, agent
frameworks, MCP servers, retired models and the AI rules that fired — plus the correlation: external AI providers in a
repository that also has open personal-data or secrets findings. The portfolio report folds the same per repository,
with flags per assessment and team attribution by tags only.

**Spend and seats (optional, read-only).** Store a provider admin/billing key under *Settings → Credentials*, then
connect it as a cost source and sync — the key never travels through the AI Estate endpoints:

```bash
# 1. store the key (write-only, AES-GCM under ATLAS_MASTER_KEY)
curl -X PUT http://localhost:8080/api/credentials/openai-admin -H 'Content-Type: application/json' \
     -d '{"secret":"sk-admin-...","description":"OpenAI org admin key (read)"}'
# 2. connect the source (github-copilot needs the organization login as scope)
curl -X PUT http://localhost:8080/api/ai-estate/cost/sources/openai -H 'Content-Type: application/json' \
     -d '{"credentialName":"openai-admin"}'
curl -X PUT http://localhost:8080/api/ai-estate/cost/sources/github-copilot -H 'Content-Type: application/json' \
     -d '{"credentialName":"gh-billing","scope":"my-org"}'
# 3. pull the last 35 days (per-provider outcome; a failing provider never hides the others)
curl -X POST http://localhost:8080/api/ai-estate/cost/sync -H 'Content-Type: application/json' -d '{"days":35}'
# 4. read the summary (also in the portfolio report)
curl http://localhost:8080/api/ai-estate/cost?days=30
```

Providers: **OpenAI** organization Costs API (per project and line item), **Anthropic** Admin cost report (per
workspace and description) plus Claude Code analytics folded to daily aggregates (active developers, sessions,
estimated cost per model — never per developer), **GitHub Copilot** billing seats (idle for 60+ days, pending
cancellation; seat holders stored as keyed pseudonyms) with a list-price estimate. Provider-reported and estimated
amounts are always shown separately and never summed. Cost data lives in its own `governance` schema (own EF
migrations, same database); the write side of `/api/ai-estate/cost/*` is admin-only when authentication is on.

**Developer usage (opt-in CLI).** To see usage and estimated cost *per developer*, each developer runs `atlas-agent`
on their own machine (single-file binaries for Windows, Linux and macOS are attached to every release). It reads the
usage logs Claude Code already keeps locally (`~/.claude/projects`), shows the daily aggregates it will send — tokens,
requests and sessions per model, never prompts, code, paths or project names — and posts only that:

```bash
atlas-agent --server https://atlas.example.com --token <ATLAS_TOKEN> --days 7 --dry-run # preview, sends nothing
atlas-agent --server https://atlas.example.com --token <ATLAS_TOKEN> --days 7 # send (analyst token)
atlas-agent ... --anonymous # report under a stable per-machine pseudonym instead of a name
```

Re-running is idempotent (a day's line is replaced, never counted twice). To report without thinking about it,
`atlas-agent install --server … --token … --every 12h` sends once, saves the settings under `~/.atlas-agent` and
registers a per-user schedule with the OS scheduler (Task Scheduler, launchd or cron); `atlas-agent status` and
`atlas-agent uninstall` show and remove it. `--every 5m` keeps the *Live* panel current; `atlas-agent watch` keeps a
terminal open and re-sends today whenever the transcripts change (foreground, Ctrl+C stops it). There is still no
service and no resident process outside a terminal you can see: the scheduler starts the agent, it reports, it exits,
and the server cannot configure it. Tools read: Claude Code and Codex CLI; Cursor, Copilot and Gemini CLI keep no
token counts locally, so the agent says so instead of guessing.

**Telemetry (the push path).** Atlas is also an OpenTelemetry receiver for AI usage: `POST /api/ai-estate/otlp/v1/metrics`
and `/v1/traces` accept OTLP/HTTP JSON. Claude Code and Gemini CLI export OpenTelemetry natively (a handful of
environment variables, copy-paste ready on the *Connect telemetry* card), gateways such as LiteLLM emit a GenAI span
per request, and any application instrumented with the OpenTelemetry GenAI conventions can point at Atlas directly or
through a collector. Usage arrives within one export interval, so the Live panel, budgets and forecasts cover every AI
in the company, not only what a CLI reads from disk. People are pseudonymised by default; services appear by name.

**Estimated vs billed, and forecasts that learn from the invoice.** The *Spend & cost sources* tab reconciles, per
provider, the catalog estimate with what the billing API reported for the same days; once seven days overlap the ratio
calibrates the projections (a *calibrated month* tile appears in Developer usage). Projections use same-weekday means
over the last four weeks with a likely range, and a burn-up chart shows the month's cumulative spend against them.
Cost sources: OpenAI, Anthropic, GitHub Copilot and **Cursor** (Admin API: seats, this cycle's spend per member, and
per-request token usage per member, which lands in Developer usage as tool `cursor`).

Billing is pulled automatically once a day (`Atlas__AiEstate__CostSync__HourUtc`, default 06:00 UTC) for every connected
source, and the usage data exports as CSV for finance (`GET /api/ai-estate/usage/export.csv`, one line per day,
developer, team, tool and model). The dashboard shows month-to-date and projected AI spend next to the estate.

**Budgets, alerts and teams.** The *Budgets & teams* tab holds monthly estimated-spend budgets per tenant, team,
provider, model, developer or tool, with spent and projected bars; alerts at 50 / 80 / 100 % and on an anomalous day
go to the tenant's webhook, Slack or Teams channels, or to a team's own channels when it has them. Teams group
developers and services into cost centres; spend, month
to date and projection roll up per team, and the summary breaks the whole company down by team, provider and tool.

The *Developer usage & prices* tab on the AI estate page shows a *Live* panel (who reported in the last 15 minutes,
tokens and cost so far today, tokens in the last hour, an intraday curve — refreshed every minute), a *Forecast*
(month to date, projected month, next 30 days at the 7-day pace, trend — formulas shown), who reported, tokens,
estimated cost, per-developer average and projections, per-model and per-day breakdowns, and the step-by-step guide. Prices are USD per million
tokens from a versioned builtin catalog (`ai-prices.json`; `Atlas__AiEstate__PriceCatalogPath` replaces it) **plus the
prices you set in the UI** per model id or regex family — models nothing prices are shown as *unpriced*, never as zero,
and offered as one-click suggestions; saving a price reprices every stored report. The *Spend & cost sources* tab
explains, per provider, how to obtain the admin key a cost source needs.

What Atlas deliberately does **not** do here: no silent endpoint agent, no browser extension, no per-user shadow-AI
tracking, no policy engine beyond the allowlist. Those wait for evidence that customers want them.

## Web UI

**Built-in manual.** *Help* in the sidebar (or the **?** button in any page header) opens the in-app manual: one
section per feature and per configuration surface, in English and Portuguese, searchable (`/help?q=…`), deep-linkable
(`/help#budgets`), and filled with live facts from the instance (version, sign-in mode, your roles and tenant, the daily
billing schedule, the price catalog, unpriced models, available cost providers). The **?** knows the current page and
tab, so it lands on the right section.
...
schedule, targets), compare, a live queue (server-sent events), the rule catalog with severity tuning, credentials, AI, API tokens, the cost model and an administration page (tenants + per-tenant notification channels). English and Portuguese, light/dark/system theme,
a presentation mode for meetings, deep-linkable tabs (`?tab=…`).

The **AI estate** page has four tabs. *Inventory*: what AI the portfolio uses — providers with approval status, agent
frameworks, MCP servers, per-repository flags for unapproved providers and AI next to personal data or secrets.
*Approved providers*: the allowlist, edited from the signature catalog and applied to every assessment on its next run
(the deployment configuration is only the fallback). *Spend & cost sources*: provider-reported and estimated spend,
Copilot seats, and the cost-source management (connect a provider through a stored credential, sync, disconnect) with a
step-by-step **How to connect** guide per provider — where the admin key is created, which key type is accepted, what
Atlas reads. *Developer usage & prices*: the reports sent by the `atlas-agent` CLI (developers reporting, tokens,
estimated cost, per-developer table, per-model and per-day breakdowns, the CLI guide including the scheduled
`install`) and the **model prices** editor (USD per million tokens per model or regex family, unpriced models offered as
one-click suggestions, every change repricing the stored reports). Each assessment has an **AI estate** tab with the
same facts for that repository, and a **Waivers** tab gathers every human decision on its findings (active waivers with
reopen, expired and reopened history, standing policies with an inline form, waivers to migrate after a rule's major
bump).
...
`GET /api/assessments/{id}/gate?failOn=High&minScore=60` — exit code 1 when the gate fails. A third knob,
`&failOnNew=High`, is the **baseline mode** legacy estates can adopt on day one: only findings the latest run
introduced fail the gate (the first completed run establishes the baseline), so the existing stock of debt never
blocks a pipeline — regressions do. Wrappers: the composite
...
**Pull-request comment.** `GET /api/assessments/{id}/pr-comment?failOn=&minScore=&failOnNew=&lang=&ai=` renders a Markdown
...
| `Atlas:Vulnerabilities` | `SyncEnabled`, `SyncUrls`, `OsvBundlePath` — add the OSV `Maven/all.zip` and/or `PyPI/all.zip` exports to `SyncUrls` to enable Java/Python CVE matching |
| `Atlas:Licenses` | `Enabled`, `CachePath`, `Denied`, `MaxLookupsPerRun`, `Concurrency` |
| `Atlas:Cost` | Cost model parameters (see above); currency/hourly rate/team size can be overridden per tenant in *Settings → Cost model* |
| `Atlas:Report` | `BrandName`, `PreparedBy`, `LogoDataUri`, `AccentColor`, `PdfServiceUrl`, `ChromiumPath` |
| `Atlas:Notifications` | `WebhookUrl`, `Secret`, `PublicBaseUrl`, `SlackWebhookUrl`, `TeamsWebhookUrl`, `DigestDayOfWeek`, `DigestHourUtc` — each overridable per tenant in *Settings → Administration* |
...
| `Atlas:AiEstate` | `ApprovedProviders` (array of provider ids, e.g. `azure-openai`, `anthropic`; empty = the unapproved-provider rule never fires), `CatalogPath` (custom signature catalog JSON replacing the builtin one) — in compose: `Atlas__AiEstate__ApprovedProviders__0: azure-openai` |
...
src/
  ...
  Atlas.Security.Redaction/ shared secret hygiene: snippet redaction, keyed fingerprints (no dependencies)
  Atlas.Governance.*/ governance module: Domain, Application, Contracts, Infrastructure — own `governance`
                              schema and migrations; AI cost sources, cost/seat facts, read-only provider clients
  Atlas.Scanner.*/ scanners: Dependencies, Security, Secrets, Privacy, Quality, Architecture, Database,
                              Infrastructure, JavaScript, Java, Python, Licenses, AI Estate — behind one IScanner contract
...
**Which languages?** C# (semantic where symbols resolve) and VB.NET through Roslyn; Java and Python
(syntactic: metrics, complexity, security patterns, plus manifests — Maven/Gradle and
requirements/pyproject/Pipfile — with runtime/framework end-of-life and OSV CVEs), SQL scripts and
JavaScript/TypeScript through text parsers; plus project files, lockfiles, configuration, Dockerfiles and compose
files. Other languages are inventoried by file count only.
...
**Estimates in my currency?** Yes — *Settings → Cost model* sets the tenant's currency, hourly rate and team size,
and every estimate and report uses them. There is deliberately no FX conversion: an hourly rate is a market fact
(a US team is estimated at US$ rates, not at converted BRL), so you state your market's numbers once.

**Can I bring findings from other tools?** Yes — POST a SARIF 2.1.0 log (ESLint, Semgrep, Trivy, CodeQL…) to
`/api/assessments/{id}/sarif` or upload it under *Settings → Import SARIF*. Each tool becomes its own scanner:
its findings are triaged, suppressed and scored like Atlas's own, and a later import resolves what the tool no
longer reports.

**How do I see it working without scanning anything?** Click *Load demo data* on the empty dashboard
(or `POST /api/demo`): five entirely fictional assessments with findings, scores, trend and reports
appear instantly; `DELETE /api/demo` removes them.

**Does Atlas justify the investment?** The modernization tab and the report show both sides: what each
strategy costs (cost.v1 ranges) and what staying legacy costs every year (savings.v1 — hosting,
extended support, SQL licensing), with the payback per strategy. All parameters are
configurable and every assumption is printed.

**Can I accept a risk temporarily?** Suppress the finding (or create a policy) with an expiry. When the waiver
ends, the finding reopens on its own and the health score is recomputed — accepted risks cannot silently become
permanent.

**Does it find dead code?** It flags *candidates*: top-level `internal` types and `private` members (methods,
fields, properties, events) that nothing in the analyzed source references. Framework-instantiated shapes
(controllers, handlers, migrations, workers…), attributed types and entry points are skipped, names mentioned in
string literals or markup/config files count as alive, and the findings stay Informational because reflection,
DI-by-convention and serialization can't be seen statically — confirm with find-usages before deleting.

## Status and limits

Atlas is in active development and used in pilots; the current line is **v0.54**. Analyzed today: .NET (C#), SQL,
JavaScript/TypeScript, Java (Maven/Gradle) and Python (requirements/pyproject/Pipfile), plus the language-agnostic
scanners (licenses, secrets, personal data, git history, AI estate). What is deliberately *not* there yet: other
languages, dynamic analysis of any kind, automatic application of AI patches (suggestions are diffs for a human to
review), a silent endpoint agent (the `atlas-agent` CLI is run or scheduled by the developer, never installed as a
service), and hosted/SaaS operation — Atlas is designed to run inside your own infrastructure.
