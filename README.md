...
- Providers outside your approved list (`ai.unapproved-provider`, High) — the V0.5 policy is a plain allowlist:
...
the Findings tab surfaces **waivers to migrate** after a rule's major bump, migrated only on request.
