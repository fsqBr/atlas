...
public sealed class GovernanceCostTests(PostgresFixture fixture) : IClassFixture<PostgresFixture>
{
    ...
    private sealed record UsageSummaryRow(int ReportingActors, decimal EstimatedCost, long UnpricedTokens, string PriceCatalogVersion, List<UsageActorRow> Actors, ForecastRow Forecast);
