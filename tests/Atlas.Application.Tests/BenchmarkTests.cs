...
public class BenchmarkTests
{
    ...
    [Fact]
    public void Percentile_rank_is_the_share_at_or_below_the_score()
    {
        int[] all = [21, 47, 56, 89];
        Assert.Equal(25, Benchmark.PercentileRank(all, 21));
        Assert.Equal(75, Benchmark.PercentileRank(all, 56));
        Assert.Equal(100, Benchmark.PercentileRank(all, 89));
