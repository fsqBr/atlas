...
public class AiEstateScannerTests
{
    ...
    private static async Task<List<FindingCandidate>> RunAsync(Dictionary<string, string> files, AiEstateOptions? options = null, IReadOnlyList<ProjectFact>? projects = null)
    {
        var sink = new Sink();
        ...
        var result = await scanner.ExecuteAsync(new ScanContext
        {
            ...
            Languages = languages, Findings = sink, Today = new DateOnly(2026, 9, 6),
