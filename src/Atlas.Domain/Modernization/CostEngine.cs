...
public sealed record CostParameters
{
    ...
    // savings.v1 — the annual run-rate of staying legacy (the other half of the business case).
    public decimal WindowsHostingPerLegacyAppYear { get; init; } = 4200;
    public decimal ExtendedSupportPerLegacyAppYear { get; init; } = 1500;
    public decimal SqlServerSavingsPerYear { get; init; } = 16000;
}
