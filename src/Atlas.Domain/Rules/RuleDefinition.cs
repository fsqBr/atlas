...
public sealed class RuleDefinition
{
    ...
    /// <summary>
    /// MAJOR.MINOR.PATCH. MAJOR = the rule changed meaning (what it detects, where it points) — the only
    /// change that alters fingerprints and forces re-triage; MINOR = detects more of the same; PATCH = text/severity/FP fixes.
    /// </summary>
