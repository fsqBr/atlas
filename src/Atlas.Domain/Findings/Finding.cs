...
public sealed class Finding
{
    ...
    /// <summary>
    /// Fingerprint this finding superseded when its rule's major version was bumped.
    /// Lets triage offer migrating the predecessor's waiver instead of silently keeping or losing it.
    /// </summary>
    public string? PredecessorFingerprint { get; private set; }
