...
public static partial class PortfolioHtmlRenderer
{
    ...
    public static string Render(PortfolioReport report, ReportLocale? locale = null, ReportOptions? options = null)
    {
        ...
        RenderAiEstate(sb, m.AiEstate, s, c);
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["aiCostTitle"] = "AI spend (last {0} days)",
        ["aiCostBasis"] = "Basis",
        ["aiCostTotal"] = "Total",
        ["aiCostTop"] = "Largest items",
        ["aiLastSync"] = "Last sync",
        ["aiCostSeats"] = "{0} seats: {1} total · {2} active · {3} idle for 60+ days · {4} pending cancellation",
        ["aiPerDay"] = "day",
        ["aiCostNote"] = "Provider-reported and estimated amounts are listed separately and never summed; estimates name their price catalog. Seats and activity are counts — never per person.",
        ["ProviderReported"] = "provider-reported",
        ["Estimated"] = "estimated",
        ["active-developers"] = "active developers",
        ["sessions"] = "sessions",
        ["aiEstate"] = "AI estate across the portfolio",
        ["aiWithAi"] = "Repositories using AI",
        ["aiScanned"] = "of {0} scanned",
        ["aiProviders"] = "Providers",
        ["aiMcp"] = "MCP servers",
        ["aiRemoteMcp"] = "remote",
        ["aiUnapproved"] = "Unapproved providers",
        ["aiRetired"] = "Retired model references",
        ["aiSecretsMcp"] = "Credentials in MCP configs",
        ["aiWithPii"] = "AI + personal data",
        ["aiWithSecrets"] = "AI + leaked secrets",
        ["aiProvider"] = "Provider",
        ["aiKind"] = "Kind",
        ["aiAssessments"] = "Repositories",
        ["aiStatus"] = "Status",
        ["aiApproved"] = "approved",
        ["aiNotApproved"] = "NOT approved",
        ["aiNoAllowlist"] = "no allowlist configured",
        ["aiFrameworks"] = "Agent frameworks",
        ["aiRowName"] = "Assessment",
        ["aiRowProviders"] = "Providers",
        ["aiRowFrameworks"] = "Frameworks",
        ["aiRowMcp"] = "MCP",
        ["aiRowFlags"] = "Flags",
        ["aiFlagUnapproved"] = "unapproved provider",
        ["aiFlagPii"] = "PII co-located",
        ["aiFlagSecrets"] = "secrets co-located",
        ["aiFlagRetired"] = "retired model",
        ["aiFlagSecretMcp"] = "credential in MCP config",
        ["aiNone"] = "No AI usage was inventoried yet — this section fills in once assessments run with the AI Estate scanner.",
        ["aiNote"] = "Correlations use the same repositories' persisted privacy and secrets findings; teams are attributed by assessment tags only — never per person. Signature catalog {0}.",
    ...
    private static readonly Dictionary<string, string> Pt = new()
    {
        ...
        ["aiCostTitle"] = "Gasto com IA (últimos {0} dias)",
        ["aiCostBasis"] = "Base",
        ["aiCostTotal"] = "Total",
        ["aiCostTop"] = "Maiores itens",
        ["aiLastSync"] = "Última sincronização",
        ["aiCostSeats"] = "{0} seats: {1} no total · {2} ativos · {3} ociosos há 60+ dias · {4} com cancelamento pendente",
        ["aiPerDay"] = "dia",
        ["aiCostNote"] = "Valores reportados pelo provedor e estimados são listados separadamente e nunca somados; estimativas nomeiam seu catálogo de preços. Seats e atividade são contagens — nunca por pessoa.",
        ["ProviderReported"] = "reportado pelo provedor",
        ["Estimated"] = "estimado",
        ["active-developers"] = "desenvolvedores ativos",
        ["sessions"] = "sessões",
        ["aiEstate"] = "AI estate no portfólio",
        ["aiWithAi"] = "Repositórios que usam IA",
        ["aiScanned"] = "de {0} analisados",
        ["aiProviders"] = "Provedores",
        ["aiMcp"] = "Servidores MCP",
        ["aiRemoteMcp"] = "remotos",
        ["aiUnapproved"] = "Provedores não aprovados",
        ["aiRetired"] = "Referências a modelos descontinuados",
        ["aiSecretsMcp"] = "Credenciais em configs MCP",
        ["aiWithPii"] = "IA + dados pessoais",
        ["aiWithSecrets"] = "IA + segredos expostos",
        ["aiProvider"] = "Provedor",
        ["aiKind"] = "Tipo",
        ["aiAssessments"] = "Repositórios",
        ["aiStatus"] = "Situação",
        ["aiApproved"] = "aprovado",
        ["aiNotApproved"] = "NÃO aprovado",
        ["aiNoAllowlist"] = "sem allowlist configurada",
        ["aiFrameworks"] = "Frameworks de agente",
        ["aiRowName"] = "Assessment",
        ["aiRowProviders"] = "Provedores",
        ["aiRowFrameworks"] = "Frameworks",
        ["aiRowMcp"] = "MCP",
        ["aiRowFlags"] = "Sinais",
        ["aiFlagUnapproved"] = "provedor não aprovado",
        ["aiFlagPii"] = "PII no mesmo repositório",
        ["aiFlagSecrets"] = "segredos no mesmo repositório",
        ["aiFlagRetired"] = "modelo descontinuado",
        ["aiFlagSecretMcp"] = "credencial em config MCP",
        ["aiNone"] = "Nenhum uso de IA foi inventariado ainda — esta seção é preenchida quando os assessments rodam com o scanner AI Estate.",
        ["aiNote"] = "As correlações usam os findings persistidos de privacidade e segredos dos mesmos repositórios; times são atribuídos apenas por tags de assessment — nunca por pessoa. Catálogo de assinaturas {0}.",
        ["external-api"] = "API externa",
        ["gateway"] = "gateway",
        ["local-runtime"] = "runtime local",
        ["local-inference"] = "inferência local",
        ["vector-store"] = "vector store",
