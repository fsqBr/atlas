...
if (app.Configuration.GetValue<bool>("Atlas:AutoMigrate"))
{
    ...
    AutoMigration.Apply(scope.ServiceProvider.GetRequiredService<AtlasDbContext>(), "atlas");
    AutoMigration.Apply(scope.ServiceProvider.GetRequiredService<Atlas.Governance.Infrastructure.Persistence.GovernanceDbContext>(), Atlas.Governance.Infrastructure.Persistence.GovernanceDbContext.Schema);
}
