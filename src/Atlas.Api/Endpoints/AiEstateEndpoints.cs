...
internal static class AiEstateEndpoints
{
    public static void Map(WebApplication app)
    {
        ...
        group.MapGet("/usage/prices", (PriceCatalog prices) => Results.Ok(new PriceCatalogResponse(
            prices.Version, prices.Currency, prices.Document.Note, prices.Source,
            prices.Document.Models.Select(m => new ModelPriceResponse(m.Pattern, m.Input, m.Output, m.CacheRead, m.CacheWrite)).ToList())));
