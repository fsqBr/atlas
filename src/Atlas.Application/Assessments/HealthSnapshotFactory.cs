...
public static class HealthSnapshotFactory
{
    ...
    public static HealthSnapshot Create(
        Guid tenantId, Guid assessmentId, string? commitSha, IReadOnlyList<Finding> openFindings, int projectCount, Guid? runId = null)
    {
        ...
        return new HealthSnapshot(
            ...
            JsonSerializer.Serialize(result.Dimensions, Json), runId);
    }
