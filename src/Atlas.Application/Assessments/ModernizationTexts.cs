...
public static class ModernizationTexts
{
    ...
    public static string Text(string key, string? lang)
    {
        ...
        return key switch
        {
            ...
            "saving.windows-hosting" => pt ? "Hospedagem Windows dos apps legados" : "Windows hosting of the legacy apps",
            "saving.extended-support" => pt ? "Suporte estendido / risco de fim de suporte" : "Extended support / end-of-support exposure",
            "saving.sql-server" => pt ? "Licenciamento SQL Server (consolidação)" : "SQL Server licensing (consolidation)",
            "assumption.saving-hosting-rate" => pt ? "Hospedagem Windows por app/ano" : "Windows hosting per app/year",
            "assumption.saving-support-rate" => pt ? "Suporte estendido por app/ano" : "Extended support per app/year",
            "assumption.saving-sql" => pt ? "Economia anual com SQL Server" : "Annual SQL Server saving",
            "assumption.saving-scope" => pt ? "Apps legados considerados" : "Legacy apps considered",
