...
public static class DependencyInjection
{
    public static IServiceCollection AddAtlasApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<Findings.WaiverMigrationHandler>();
        ...
        services.TryAddScoped<AiEstate.IAiCostSummarySource, AiEstate.NullAiCostSummarySource>();
        services.AddScoped<AiEstate.AssessmentAiEstateBuilder>();
