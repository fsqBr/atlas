...
public sealed class LegacyApiWalker(string filePath) : CSharpSyntaxWalker
{
    ...
    public override void VisitObjectCreationExpression(ObjectCreationExpressionSyntax node)
    {
        ...
        if (LegacyTypes.TryGetValue(typeName, out var why))
        {
...
internal static class ObsoleteApiDetector
{
    ...
    public static IReadOnlyList<PatternFact> Collect(CSharpCompilation compilation, SyntaxTree tree, string filePath, CancellationToken cancellationToken)
    {
