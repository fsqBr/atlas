...
import { CliGuide, UsageView } from "../pages/DeveloperUsageCard";
import { guideEndpoints, isGuideProvider, ProviderGuide } from "../pages/ProviderGuides";
import type { AiUsageSummary, PriceCatalog } from "../api";
...
const usage: AiUsageSummary = {
  ...
  actors: [
    { actor: "bruno", tools: ["claude-code"], sessions: 3, requests: 40, tokens: 2_000_000, estimatedCost: 15, unpricedTokens: 0, lastReportUtc: "2026-09-06T10:00:00Z", lastPeriod: "2026-09-06" },
    { actor: "anon-1a2b3c4d5e", tools: ["claude-code"], sessions: 2, requests: 10, tokens: 1_500_000, estimatedCost: 6, unpricedTokens: 200, lastReportUtc: "2026-09-05T10:00:00Z", lastPeriod: "2026-09-05" },
  ],
  byModel: [
