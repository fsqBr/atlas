...
import { AiEstatePage } from "./pages/AiEstatePage";
    ...
    <div className="app">
      ...
      <aside className={`sidebar${open ? " open" : ""}`}>
        ...
        <nav className="side-nav" aria-label="Main">
          ...
          {item("/settings/admin", "⚙", t("nav.admin"))}
          {item("/settings/tokens", "⌗", t("nav.tokens"))}
          <div className="side-group">{t("nav.group.help")}</div>
          {item("/help", "?", t("nav.help"))}
        </nav>
      ...
      <div className="main">
        ...
        <main className="page">
          <Routes>
            ...
            <Route path="/ai-estate" element={<AiEstatePage />} />
