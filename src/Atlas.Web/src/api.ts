...
export type Team = { id: string; name: string; members: string[]; updatedBy: string; updatedAtUtc: string };
...
export const api = {
  ...
  upsertTeam: (body: { id: string | null; name: string; members: string[]; author?: string | null }) =>
