...
export const api = {
  ...
  reportUrl: (id: string, lang: string) => withToken(`/api/assessments/${id}/report?lang=${encodeURIComponent(lang)}`),
  sbomUrl: (id: string) => withToken(`/api/assessments/${id}/sbom`),
  reportPdfUrl: (id: string, lang: string) => withToken(`/api/assessments/${id}/report.pdf?lang=${encodeURIComponent(lang)}`),
