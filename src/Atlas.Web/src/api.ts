...
export type UsageForecast = { monthToDateCost: number; daysElapsedInMonth: number; daysInMonth: number; projectedMonthCost: number; dailyAverage7: number; dailyAverage30: number; projectedNext30Cost: number; trendPercent: number | null; monthToDateTokens: number; unpricedTokensMonthToDate: number };
