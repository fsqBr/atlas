...
export type PriceCatalog = { version: string; currency: string; note: string | null; source: string; models: { pattern: string; input: number; output: number; cacheRead: number | null; cacheWrite: number | null }[] };
