...
export type UsageActor = { actor: string; tools: string[]; sessions: number; requests: number; tokens: number; estimatedCost: number; unpricedTokens: number; lastReportUtc: string; lastPeriod: string };
...
export type AiUsageSummary = {
  ...
  actors: UsageActor[]; byModel: UsageModel[]; byDay: UsageDay[];
};
